...
module.exports.run = async (client, message, args, mentionFix, getUser) => {
	...
	message.channel.send(
		"Global tracker has been setup. This tracker will log all rare spawns that are 100M+.",
	);

	console.log(
		`[SETUP] ${message.guild.name} (${message.guild.id}) global tracker has been setup.`,
	);
};
...
module.exports.config = {
	...
	usages: ["globaltracker"],
	examples: ["globaltracker"],
};
