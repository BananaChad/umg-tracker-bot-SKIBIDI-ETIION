...
module.exports.run = async (client, message, args, mentionFix, getUser) => {
	...
	message.channel.send(
		"Tracker has been setup. It will log rare spawns in the channel, for username tracker, run the 'track' command.",
	);
	console.log(
		`[SETUP] ${message.guild.name} (${message.guild.id}) has been setup.`,
	);
};
